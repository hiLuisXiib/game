...
// Thanks  Kushagra Agarwal https://twitter.com/solitarydesigns/ 
// and Paloma Castro https://dribbble.com/shots/3686405-Sailor-Moon-Icons
...
function init() {
	...
	function gameOver() {
		...
		if(player.y > height/2 && flag === 0) {
			...
			tweet.href='https://twitter.com/share?url=http://www.xbr.pw/SailorJump&text=He logrado un total de ' +score+ ' en Sailor Jump Game!&count=horiztonal&via=xiibertravel&related=xiibertravel';
		
			var facebook = document.getElementById("fbBtn");
			facebook.href='https://facebook.com/sharer.php?s=100&p[url]=http://www.xbr.pw/SailorJump/8&p[title]=He logrado un total de ' +score+ ' en Sailor Jump Game!&p[summary]=Sin los malos momentos, no apreciaríamos los buenos. Sailor Moon';
